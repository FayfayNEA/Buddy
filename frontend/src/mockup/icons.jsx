// Inline SVG icon set (Feather-style, 24×24, stroke-based) for crisp mockup icons.
// Keys are semantic names the LLM can request; falls back to emoji/text for anything unlisted.
...
const PATHS = {
  ...
  album: <><rect x="3" y="3" width="18" height="18" rx="2" ry="2" /><circle cx="12" cy="12" r="3" /><circle cx="12" cy="12" r="0.5" fill="currentColor" /></>,
  play_circle: <><circle cx="12" cy="12" r="10" /><path d="M10 8l6 4-6 4z" /></>,
  download: <><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><path d="M7 10l5 5 5-5" /><path d="M12 15V3" /></>,
  filter: <path d="M22 3H2l8 9.46V19l4 2v-8.54z" />,
  chevronRight: <path d="M9 18l6-6-6-6" />,
  plus_circle: <><circle cx="12" cy="12" r="10" /><path d="M12 8v8" /><path d="M8 12h8" /></>,
};

// Icons that read better filled than stroked
const FILLED = new Set(['heart', 'star', 'play', 'pause', 'bookmark']);

export function hasSvgIcon(name) {
  return !!PATHS[name];
}

export function SvgIcon({ name, size = 24, color = 'currentColor' }) {
